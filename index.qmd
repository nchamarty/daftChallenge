...
pgm.render()
_ = plt.title("Simplified Lind's Model (1747)", fontsize=16, fontweight='bold', pad=20)
```
...
pgm.render()
# Add a title
_ = plt.title("Updated Bacterial Theory (Late 19th Century)", fontsize=16, fontweight='bold', pad=20)
```
...
pgm.render()
# Add a title
_ = plt.title("Simplified Modern Understanding (1930s onwards)", fontsize=16, fontweight='bold', pad=20)
```
